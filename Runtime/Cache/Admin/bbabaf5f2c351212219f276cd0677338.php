<?php if (!defined('THINK_PATH')) exit();?><form class="layui-form info-form" action="">
	...
	<div class="layui-form-item">
		...
		<div class="layui-input-block">
			<input name="name" id="name" value="<?php echo ($info["name"]); ?>" lay-verify="required" autocomplete="off" placeholder="请输入职位名称" class="layui-input" type="text">
		</div>
	</div>
	<div class="layui-form-item">
		<label class="layui-form-label">职位状态：</label>
		<div class="layui-input-block">
			<?php echo W('common/switchCheck',array(status,'是|否',$info['status'] ? $info['status'] : 1));?>
		</div>
	</div>
	<div class="layui-form-item">
