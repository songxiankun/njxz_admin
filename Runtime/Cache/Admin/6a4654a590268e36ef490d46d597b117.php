           ...
           <div class="layui-inline">
				<form class="layui-form">
					<div class="layui-input-inline">
						<input name="send_date" id="send_date" value="<?php echo ($info["format_entry_date"]); ?>" lay-verify="datetime" placeholder="请选择短信发送日期" autocomplete="off" class="layui-input" type="text">
					</div>
					<div class="layui-input-inline">
