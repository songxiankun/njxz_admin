...
<div class="layui-fluid">
        ...
        <div class="layui-form-item">
            <div class="layui-inline">
                <form class="layui-form">
                    <div class="layui-input-inline">
                        <input type="text" name="keys" placeholder="请输入维修人员手机号" autocomplete="off" class="layui-input">
                    </div>
            ...
            <div class="layui-inline">
                <div class="layui-input-inline" style="width: auto;">
                    <?php echo W('funcNode/btnAdd',array(添加维修人员));?>
                    <?php echo W('funcNode/btnDAll',array(批量删除));?>
                    <?php echo W('funcNode/btnImport',array(导入数据));?>
                </div>
            </div>
        </div>
    </div>
    ...
    <script type="text/html" id="toolBar">
        ...
        <?php echo W('funcNode/btnDetail',array(查看详情));?>
