...
function uploadOne($files) {
    ...
    // 设置附件上传类型
    $upload->allowExts = array("jpg","JPG","jpeg","JPEG","gif","GIF","png","PNG","pdf","doc","txt","docx");
...
/**
 * 删除OSS上指定文件
 * @param string $object 文件路径(例如： /Public/README.md文件  传Public/README.md 即可)
 */
...
function get_file_format($filename) {
    // 取文件后缀名
    $str=strtolower(pathinfo($filename, PATHINFO_EXTENSION));
    // 图片格式
 ...
 * @return array <multitype:, mixed> excel文件内容数组
 * @throws PHPExcel_Exception
 * @throws PHPExcel_Reader_Exception
 */
