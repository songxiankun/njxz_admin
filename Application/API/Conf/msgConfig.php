...
define('MESSAGE_INTERNAL_FAT', '参数过多');
...
define('MESSAGE_OLD_PASSWORD_ERROR', '原密码错误');
define('MESSAGE_USER_FIRBIDDEN', '账号已被禁用');
define('MESSAGE_NO_MOBILE', '请输入手机号');
define('MESSAGE_NO_PASSWORD', '请输入密码');
define('MESSAGE_NO_NEW_PASSWORD', '请输入新密码');
define('MESSAGE_TWO_PASSWORD_INCONSISTENT', '两次密码不一致，请重新输入');
define('MESSAGE_MOBILE_REGISTERED', '用户已注册');
define('MESSAGE_NO_USER', '用户不存在');
define('MESSAGE_NO_VCODE', '请输入验证码');
define('MESSAGE_VCODE_ERROR', '验证码错误');
define('MESSAGE_INVALID_PASSWORD', '请输入有效的密码');
define('MESSAGE_MOBILE_UNREGISTERED', '手机号未注册');
define('MESSAGE_INVALID_CODE',  "邀请码无效");
define('MESSAGE_ACCOUNT_BOUNDED',  "该手机号已绑定");
define('MESSAGE_MOBILE_SMS_LIMIT', '操作过于频繁，请稍后再试');
define('MESSAGE_NO_AVATAR', '请上传头像');
define('MESSAGE_AVATAR_WRONG', '上传头像错误');